...
class UIController {
    ...
    async renderFlatView(options = {}) {
        ...
        const c1Cards = [
            ...
            // ── LiDAR & 3D ──
            { id: 'flat-3d-ni-lidar-a26-pointcloud', name: 'A26 Dualling LiDAR Point Cloud — Glarryford to Ballymena (3D)', years: '2016', extent: 'Northern Ireland', mapIds: ['ni-lidar-a26-pointcloud'] },
            { id: 'flat-3d-ni-lidar-newry-pointcloud', name: 'Newry City Core Photogrammetry Point Cloud (3D)', years: '2018', extent: 'Northern Ireland', mapIds: ['ni-lidar-newry-pointcloud'] },
            { id: 'flat-3d-ni-lidar-york-street-pointcloud', name: 'York Street Interchange LiDAR Point Cloud (3D)', years: '2012', extent: 'Northern Ireland', mapIds: ['ni-lidar-york-street-pointcloud'] },
            { id: 'flat-3d-ni-lidar-sept2022-northcoast-pointcloud', name: 'North Coast Post-Storm Recovery LiDAR — Sept 2022 (3D)', years: '2022', extent: 'Northern Ireland', mapIds: ['ni-lidar-sept2022-northcoast-pointcloud'] },
            { id: 'flat-3d-ni-lidar-march2022-northcoast-pointcloud', name: 'North Coast Post-Storm Survey LiDAR — March 2022 (3D)', years: '2022', extent: 'Northern Ireland', mapIds: ['ni-lidar-march2022-northcoast-pointcloud'] },
            { id: 'flat-3d-ireland-terrain-3d', name: 'Ireland 3D Terrain — best-available LiDAR + 30 m', years: '2026', extent: 'Ireland', mapIds: ['ireland-terrain-3d', 'ireland-terrain-3d-grey'] },
            { id: 'flat-3d-ni-lidar-1m-3d', name: 'NI River-Basin LiDAR — 1 m 3D Terrain', years: '2014', extent: 'Northern Ireland', mapIds: ['ni-lidar-1m-3d', 'ni-lidar-1m-3d-grey'] },
            { id: 'flat-3d-ni-lidar-armagh-dungannon-coalisland-3d', name: 'NI LiDAR 1 m — Armagh-Dungannon-Coalisland (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-armagh-dungannon-coalisland-3d', 'ni-lidar-armagh-dungannon-coalisland-3d-grey'] },
            { id: 'flat-3d-ni-lidar-ballycastle-3d', name: 'NI LiDAR 1 m — Ballycastle (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-ballycastle-3d', 'ni-lidar-ballycastle-3d-grey'] },
            { id: 'flat-3d-ni-lidar-ballyclare-3d', name: 'NI LiDAR 1 m — Ballyclare (2009)', years: '2009', extent: 'Northern Ireland', mapIds: ['ni-lidar-ballyclare-3d', 'ni-lidar-ballyclare-3d-grey'] },
            { id: 'flat-3d-ni-lidar-ballygalley-3d', name: 'NI LiDAR 1 m — Ballygalley (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-ballygalley-3d', 'ni-lidar-ballygalley-3d-grey'] },
            { id: 'flat-3d-ni-lidar-ballygowan-3d', name: 'NI LiDAR 1 m — Ballygowan (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-ballygowan-3d', 'ni-lidar-ballygowan-3d-grey'] },
            { id: 'flat-3d-ni-lidar-ballymena-3d', name: 'NI LiDAR 1 m — Ballymena (2009)', years: '2009', extent: 'Northern Ireland', mapIds: ['ni-lidar-ballymena-3d', 'ni-lidar-ballymena-3d-grey'] },
            { id: 'flat-3d-ni-lidar-ballynahinch-3d', name: 'NI LiDAR 1 m — Ballynahinch (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-ballynahinch-3d', 'ni-lidar-ballynahinch-3d-grey'] },
            { id: 'flat-3d-ni-lidar-ballynavally-3d', name: 'NI LiDAR 1 m — Ballynavally (2007)', years: '2007', extent: 'Northern Ireland', mapIds: ['ni-lidar-ballynavally-3d', 'ni-lidar-ballynavally-3d-grey'] },
            { id: 'flat-3d-ni-lidar-banbridge-3d', name: 'NI LiDAR 1 m — Banbridge (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-banbridge-3d', 'ni-lidar-banbridge-3d-grey'] },
            { id: 'flat-3d-ni-lidar-bangor-3d', name: 'NI LiDAR 1 m — Bangor (2007)', years: '2007', extent: 'Northern Ireland', mapIds: ['ni-lidar-bangor-3d', 'ni-lidar-bangor-3d-grey'] },
            { id: 'flat-3d-ni-lidar-blackwater-3d', name: 'NI LiDAR 1 m — Blackwater (2014)', years: '2014', extent: 'Northern Ireland', mapIds: ['ni-lidar-blackwater-3d', 'ni-lidar-blackwater-3d-grey'] },
            { id: 'flat-3d-ni-lidar-bushmills-3d', name: 'NI LiDAR 1 m — Bushmills (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-bushmills-3d', 'ni-lidar-bushmills-3d-grey'] },
            { id: 'flat-3d-ni-lidar-camowen-3d', name: 'NI LiDAR 1 m — Camowen (2014)', years: '2014', extent: 'Northern Ireland', mapIds: ['ni-lidar-camowen-3d', 'ni-lidar-camowen-3d-grey'] },
            { id: 'flat-3d-ni-lidar-carrickfergus-3d', name: 'NI LiDAR 1 m — Carrickfergus (2007)', years: '2007', extent: 'Northern Ireland', mapIds: ['ni-lidar-carrickfergus-3d', 'ni-lidar-carrickfergus-3d-grey'] },
            { id: 'flat-3d-ni-lidar-carryduff-3d', name: 'NI LiDAR 1 m — Carryduff (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-carryduff-3d', 'ni-lidar-carryduff-3d-grey'] },
            { id: 'flat-3d-ni-lidar-castlederg-3d', name: 'NI LiDAR 1 m — Castlederg (2004)', years: '2004', extent: 'Northern Ireland', mapIds: ['ni-lidar-castlederg-3d', 'ni-lidar-castlederg-3d-grey'] },
            { id: 'flat-3d-ni-lidar-castlereagh-3d', name: 'NI LiDAR 1 m — Castlereagh (2007)', years: '2007', extent: 'Northern Ireland', mapIds: ['ni-lidar-castlereagh-3d', 'ni-lidar-castlereagh-3d-grey'] },
            { id: 'flat-3d-ni-lidar-clady-3d', name: 'NI LiDAR 1 m — Clady (2009)', years: '2009', extent: 'Northern Ireland', mapIds: ['ni-lidar-clady-3d', 'ni-lidar-clady-3d-grey'] },
            { id: 'flat-3d-ni-lidar-cloghmills-3d', name: 'NI LiDAR 1 m — Cloghmills (2014)', years: '2014', extent: 'Northern Ireland', mapIds: ['ni-lidar-cloghmills-3d', 'ni-lidar-cloghmills-3d-grey'] },
            { id: 'flat-3d-ni-lidar-coleraine-portstewart-portrush-3d', name: 'NI LiDAR 1 m — Coleraine-Portstewart-Portrush (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-coleraine-portstewart-portrush-3d', 'ni-lidar-coleraine-portstewart-portrush-3d-grey'] },
            { id: 'flat-3d-ni-lidar-cookstown-3d', name: 'NI LiDAR 1 m — Cookstown (2013)', years: '2013', extent: 'Northern Ireland', mapIds: ['ni-lidar-cookstown-3d', 'ni-lidar-cookstown-3d-grey'] },
            { id: 'flat-3d-ni-lidar-cullybackey-3d', name: 'NI LiDAR 1 m — Cullybackey (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-cullybackey-3d', 'ni-lidar-cullybackey-3d-grey'] },
            { id: 'flat-3d-ni-lidar-cushendall-3d', name: 'NI LiDAR 1 m — Cushendall (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-cushendall-3d', 'ni-lidar-cushendall-3d-grey'] },
            { id: 'flat-3d-ni-lidar-downpatrick-3d', name: 'NI LiDAR 1 m — Downpatrick (2009)', years: '2009', extent: 'Northern Ireland', mapIds: ['ni-lidar-downpatrick-3d', 'ni-lidar-downpatrick-3d-grey'] },
            { id: 'flat-3d-ni-lidar-dunmurry-3d', name: 'NI LiDAR 1 m — Dunmurry (2007)', years: '2007', extent: 'Northern Ireland', mapIds: ['ni-lidar-dunmurry-3d', 'ni-lidar-dunmurry-3d-grey'] },
            { id: 'flat-3d-ni-lidar-east-belfast-3d', name: 'NI LiDAR 1 m — East-Belfast (2013)', years: '2013', extent: 'Northern Ireland', mapIds: ['ni-lidar-east-belfast-3d', 'ni-lidar-east-belfast-3d-grey'] },
            { id: 'flat-3d-ni-lidar-foyle-3d', name: 'NI LiDAR 1 m — Foyle (2004)', years: '2004', extent: 'Northern Ireland', mapIds: ['ni-lidar-foyle-3d', 'ni-lidar-foyle-3d-grey'] },
            { id: 'flat-3d-ni-lidar-killyleagh-3d', name: 'NI LiDAR 1 m — Killyleagh (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-killyleagh-3d', 'ni-lidar-killyleagh-3d-grey'] },
            { id: 'flat-3d-ni-lidar-larne-3d', name: 'NI LiDAR 1 m — Larne (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-larne-3d', 'ni-lidar-larne-3d-grey'] },
            { id: 'flat-3d-ni-lidar-limavady-3d', name: 'NI LiDAR 1 m — Limavady (2004)', years: '2004', extent: 'Northern Ireland', mapIds: ['ni-lidar-limavady-3d', 'ni-lidar-limavady-3d-grey'] },
            { id: 'flat-3d-ni-lidar-lisburn-3d', name: 'NI LiDAR 1 m — Lisburn (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-lisburn-3d', 'ni-lidar-lisburn-3d-grey'] },
            { id: 'flat-3d-ni-lidar-lowerbann-3d', name: 'NI LiDAR 1 m — Lowerbann (2014)', years: '2014', extent: 'Northern Ireland', mapIds: ['ni-lidar-lowerbann-3d', 'ni-lidar-lowerbann-3d-grey'] },
            { id: 'flat-3d-ni-lidar-maghera-3d', name: 'NI LiDAR 1 m — Maghera (2009)', years: '2009', extent: 'Northern Ireland', mapIds: ['ni-lidar-maghera-3d', 'ni-lidar-maghera-3d-grey'] },
            { id: 'flat-3d-ni-lidar-magherafelt-3d', name: 'NI LiDAR 1 m — Magherafelt (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-magherafelt-3d', 'ni-lidar-magherafelt-3d-grey'] },
            { id: 'flat-3d-ni-lidar-newcastle-3d', name: 'NI LiDAR 1 m — Newcastle (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-newcastle-3d', 'ni-lidar-newcastle-3d-grey'] },
            { id: 'flat-3d-ni-lidar-newry-3d', name: 'NI LiDAR 1 m — Newry (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-newry-3d', 'ni-lidar-newry-3d-grey'] },
            { id: 'flat-3d-ni-lidar-newtownabbey-3d', name: 'NI LiDAR 1 m — Newtownabbey (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-newtownabbey-3d', 'ni-lidar-newtownabbey-3d-grey'] },
            { id: 'flat-3d-ni-lidar-newtownards-3d', name: 'NI LiDAR 1 m — Newtownards (2008)', years: '2008', extent: 'Northern Ireland', mapIds: ['ni-lidar-newtownards-3d', 'ni-lidar-newtownards-3d-grey'] },
            { id: 'flat-3d-ni-lidar-newtownstewart-3d', name: 'NI LiDAR 1 m — Newtownstewart (2004)', years: '2004', extent: 'Northern Ireland', mapIds: ['ni-lidar-newtownstewart-3d', 'ni-lidar-newtownstewart-3d-grey'] },
            { id: 'flat-3d-ni-lidar-omagh-3d', name: 'NI LiDAR 1 m — Omagh (2004)', years: '2004', extent: 'Northern Ireland', mapIds: ['ni-lidar-omagh-3d', 'ni-lidar-omagh-3d-grey'] },
            { id: 'flat-3d-ni-lidar-portadown-3d', name: 'NI LiDAR 1 m — Portadown (2009)', years: '2009', extent: 'Northern Ireland', mapIds: ['ni-lidar-portadown-3d', 'ni-lidar-portadown-3d-grey'] },
            { id: 'flat-3d-ni-lidar-randalstown-3d', name: 'NI LiDAR 1 m — Randalstown (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-randalstown-3d', 'ni-lidar-randalstown-3d-grey'] },
            { id: 'flat-3d-ni-lidar-stonyford-3d', name: 'NI LiDAR 1 m — Stonyford (2014)', years: '2014', extent: 'Northern Ireland', mapIds: ['ni-lidar-stonyford-3d', 'ni-lidar-stonyford-3d-grey'] },
            { id: 'flat-3d-ni-lidar-strabane-3d', name: 'NI LiDAR 1 m — Strabane (2004)', years: '2004', extent: 'Northern Ireland', mapIds: ['ni-lidar-strabane-3d', 'ni-lidar-strabane-3d-grey'] },
            { id: 'flat-3d-ni-lidar-tandragee-3d', name: 'NI LiDAR 1 m — Tandragee (2010)', years: '2010', extent: 'Northern Ireland', mapIds: ['ni-lidar-tandragee-3d', 'ni-lidar-tandragee-3d-grey'] },
        ...
        const tocGroups = [
            ...
            },
            {
                heading: 'LiDAR & 3D',
                members: [
                    'A26 Dualling LiDAR Point Cloud — Glarryford to Ballymena',
                    'Newry City Core Photogrammetry Point Cloud',
                    'York Street Interchange LiDAR Point Cloud',
                    'North Coast Post-Storm Recovery LiDAR — Sept 2022',
                    'North Coast Post-Storm Survey LiDAR — March 2022',
                    'Ireland 3D Terrain — best-available LiDAR + 30 m',
                    'NI River-Basin LiDAR — 1 m 3D Terrain',
                    'NI LiDAR 1 m — Armagh-Dungannon-Coalisland',
                    'NI LiDAR 1 m — Ballycastle',
                    'NI LiDAR 1 m — Ballyclare',
                    'NI LiDAR 1 m — Ballygalley',
                    'NI LiDAR 1 m — Ballygowan',
                    'NI LiDAR 1 m — Ballymena',
                    'NI LiDAR 1 m — Ballynahinch',
                    'NI LiDAR 1 m — Ballynavally',
                    'NI LiDAR 1 m — Banbridge',
                    'NI LiDAR 1 m — Bangor',
                    'NI LiDAR 1 m — Blackwater',
                    'NI LiDAR 1 m — Bushmills',
                    'NI LiDAR 1 m — Camowen',
                    'NI LiDAR 1 m — Carrickfergus',
                    'NI LiDAR 1 m — Carryduff',
                    'NI LiDAR 1 m — Castlederg',
                    'NI LiDAR 1 m — Castlereagh',
                    'NI LiDAR 1 m — Clady',
                    'NI LiDAR 1 m — Cloghmills',
                    'NI LiDAR 1 m — Coleraine-Portstewart-Portrush',
                    'NI LiDAR 1 m — Cookstown',
                    'NI LiDAR 1 m — Cullybackey',
                    'NI LiDAR 1 m — Cushendall',
                    'NI LiDAR 1 m — Downpatrick',
                    'NI LiDAR 1 m — Dunmurry',
                    'NI LiDAR 1 m — East-Belfast',
                    'NI LiDAR 1 m — Foyle',
                    'NI LiDAR 1 m — Killyleagh',
                    'NI LiDAR 1 m — Larne',
                    'NI LiDAR 1 m — Limavady',
                    'NI LiDAR 1 m — Lisburn',
                    'NI LiDAR 1 m — Lowerbann',
                    'NI LiDAR 1 m — Maghera',
                    'NI LiDAR 1 m — Magherafelt',
                    'NI LiDAR 1 m — Newcastle',
                    'NI LiDAR 1 m — Newry',
                    'NI LiDAR 1 m — Newtownabbey',
                    'NI LiDAR 1 m — Newtownards',
                    'NI LiDAR 1 m — Newtownstewart',
                    'NI LiDAR 1 m — Omagh',
                    'NI LiDAR 1 m — Portadown',
                    'NI LiDAR 1 m — Randalstown',
                    'NI LiDAR 1 m — Stonyford',
                    'NI LiDAR 1 m — Strabane',
                    'NI LiDAR 1 m — Tandragee'
                ]
            },
            {
