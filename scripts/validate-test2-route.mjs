...
assert(electionManagerSource.includes('renderSeatCircles') && electionManagerSource.includes('test2-election-seat-overlay'), '/test2 election manager must render DOM seat-circle overlays for ordinary elections');
...
assert(test2Css.includes('.test2-election-seat-dot') && test2Css.includes('rgba(0, 0, 0, .85)') && test2Css.includes('box-shadow: 0 0 0 1px rgba(0, 0, 0, .75)'), '/test2 election seat-circle DOM dots must use the requested black visible outline');
