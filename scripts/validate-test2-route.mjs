...
assert(electionManagerSource.includes('renderCountTable') && electionManagerSource.includes('election-count-table--grouped') && electionManagerSource.includes('election-count-wrapper--pane-sticky'), '/test2 count panes must use the main grouped count-table contract');
