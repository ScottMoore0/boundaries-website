...
DEFAULT_TRANSITIONS = [
    TransitionConfig(
        from_id="wards-1972",
        to_id="wards-1984",
        from_source="render/source-cache/vector-intake/wards-1972.fgb",
        to_source="render/source-cache/vector-intake/wards-1984.fgb",
    ...
    TransitionConfig(
        from_id="wards-1984",
        to_id="wards-1993",
        from_source="render/source-cache/vector-intake/wards-1984.fgb",
        to_source="render/source-cache/vector-intake/wards-1993.fgb",
    ...
    TransitionConfig(
        from_id="wards-1993",
        to_id="wards-2012",
        from_source="render/source-cache/vector-intake/wards-1993.fgb",
        to_source="render/source-cache/vector-intake/wards-2012.fgb",
    ...
    TransitionConfig(
        ...
        from_source="render/source-cache/vector-intake/wards-2012.fgb",
        to_source="render/source-cache/vector-intake/wards-2022-final-recommendations.fgb",
