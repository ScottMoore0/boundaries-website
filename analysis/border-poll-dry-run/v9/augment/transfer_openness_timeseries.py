...
print("NI-wide transfer OPENNESS by STV election, 1989-2023 (higher = more cross-community/less tribal):")
print(ts.to_string(index=False))
# decade means
for lo,hi,lab in [(1989,1998,'1989-1998'),(1999,2008,'1999-2008'),(2009,2018,'2009-2018'),(2019,2024,'2019-2024')]:
