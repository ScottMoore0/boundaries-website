...
print("NI-wide transfer OPENNESS by STV election, 1993-2023 (higher = more cross-community/less tribal):")
print(ts.to_string(index=False))
# decade means
for lo,hi,lab in [(1993,2003,'1993-2003'),(2004,2013,'2004-2013'),(2014,2024,'2014-2024')]:
