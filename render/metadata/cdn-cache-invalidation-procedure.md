...
2. Bump `TEST_CACHE_VERSION` in `/render/sw.js` when cached asset behaviour changes.
...
6. Open `/render/` in a clean browser profile and confirm diagnostics reports PMTiles/CDN health without fallback warnings.
