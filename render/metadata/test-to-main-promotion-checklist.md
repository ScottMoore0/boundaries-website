...
- `/test` service worker remains scoped to `/render/`.
...
- `render/metadata/rollback-runbook.md`
- `render/metadata/cutover-pr-checklist.md`
- `render/metadata/cdn-cache-invalidation-procedure.md`
- `render/metadata/security-dependency-review.md`
- `render/metadata/production-observability.md`
